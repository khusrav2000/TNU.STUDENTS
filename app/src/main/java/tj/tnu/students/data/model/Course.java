...
public class Course {
    ...
    public Course(int subjectId, Language sunjectName, Language teacherName, List<WeekPoint> firstWeekPoints, double firstRatingPoint, List<WeekPoint> secondWeekPoints, double secondRatingPoint, double examPoint, double totalPoints, String mark) {
    ...
    public void setSubjectName(Language sunjectName) {
        this.subjectName = sunjectName;
    }
